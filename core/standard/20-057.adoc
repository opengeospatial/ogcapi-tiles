...
:titletext: OGC API - Tiles - Part 1: Core
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|===
|*Copyright notice*
|Copyright (C) 2019-2022 Open Geospatial Consortium
...
include::clause_7_tile_tileSet.adoc[]

include::clause_8_tile_tileSetsList.adoc[]

include::clause_9_tile_datasetTileSets.adoc[]

include::clause_10_tile_collectionsSelection.adoc[]

include::clause_11_tile_geoDataTileSets.adoc[]

include::clause_11b_tile_datetime.adoc[]

include::clause_12_tile_openAPIEncoding.adoc[]

include::clause_13_tile_descriptionEncodings.adoc[]

include::clause_14_tile_dataEncodings.adoc[]
