...
include::clause_7_tile_tileSets.adoc[]

include::clause_7_tile_datasetTileSets.adoc[]

include::clause_7_tile_geoDataResourceSelection.adoc[]

include::clause_7_tile_geoDataResourceTileSets.adoc[]
