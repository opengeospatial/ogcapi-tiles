...
For example, an implementation of the https://docs.ogc.org/is/17-069r4/17-069r4.html[OGC API - Features - Part 1: Core] returns a list of links that include geospatial aspects for each geospatial data resource in the `/collections/{collectionId}` path.
