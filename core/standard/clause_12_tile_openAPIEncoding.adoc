...
==== Response
The OWS Common requirement class provides details on how to request an API definition.
...
|===
|Origin |DataType |Styled |Resource |operationId suffixes^1^ |Core |TileSet |TileSetsList |DataSetTileSets |GeoDataTileSets | Collections (Commmon - Part 2) |Styles^2^ |Coverages^2^ |Maps^2^
