...
This requirements class defines the way date and time can be used as a parameter to filter the content in the tile resource. This requirements class imports most of the functionality from OGC API - Commons.
