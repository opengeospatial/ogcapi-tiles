...
^7^ The _Collection_ origin is defined in <<rc_geoDataResourceTileSets>> conformance class and depends on the _Collections_ conformance class defined in _OGC API - Common - Part 2: Geospatial data_
