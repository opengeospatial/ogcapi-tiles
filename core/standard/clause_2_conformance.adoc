...
All Web APIs have to implement this conformance class if they are claiming to support *data set* tiles following this _OGC API - Tiles Part 1: Core_ standard.
