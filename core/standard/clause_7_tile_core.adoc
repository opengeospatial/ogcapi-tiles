...
TileMatrixSetLink is mandatory as part of the response of a ‘tiles’ description. Clients or servers are not required to support a specific default TileMatrixSet. This is illustrated by the <<TilesLinkResponseExample>>.
