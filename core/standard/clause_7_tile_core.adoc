...
The Tiles API implementation can determine the supported encodings, or more precisely the media types of the supported encodings, from the Web API definition, or from the conformance declaration (see <<rc_data_encodings>>).
