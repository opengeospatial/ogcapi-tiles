...
This draft specification assumes that data is organized into one or more geospatial resources (e.g. the "collections" in http://www.opengis.net/doc/IS/ogcapi-features-1/1.0[OGC API - Features - Part 1: Core]). Geospatial resources are referenced using URIs.
