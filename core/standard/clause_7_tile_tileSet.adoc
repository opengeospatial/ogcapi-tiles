...
include::recommendations/tileset/REC_conf-link.adoc[]

Clients or servers are not required to support a specific default TileMatrixSet.

NOTE: The OGC TileMatrixSets registry is based on the OGC Two Dimensional Tile Matrix Set standard. Refer to Annex D and H for commonly used TileMatrixSets
