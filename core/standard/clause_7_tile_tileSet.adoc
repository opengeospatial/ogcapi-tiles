...
[source,JSON]
{
  ...
  "links": [
    ...
    },
    {
     ...
     "href": "http://data.example.com/tileMatrixSets/WorldMercatorWGS84Quad",
     "type": "application/json",
    },
    {
     "rel": "item",
...
[source,JSON]
{
  ...
  "links": [
    ...
    {
     "rel": "self",
     "href": "http://data.example.com/collections/buildings/tiles/MyTilingScheme",
     "type": "application/json",
    },
    {
     "rel": "item",
     "href": "http://data.example.com/collections/buildings/tiles/MyTilingScheme4/{tileMatrix}/{tileRow}/{tileCol}.png",
     "templated": true,
     "type": "image/png",
    },
    {
