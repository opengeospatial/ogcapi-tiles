...
[[TilesetTilesLinkResponseExample]]
.Example fragment of a tileset response for a API defined TileMatrixSet
=================
[source,JSON]
{
  ...
...
===== API defined TileMatrixSets

This section provides more details on the recommendations for API defined TileMatrixSets. In the future, an extension of this standard could described mechanism to manage (create, update...) tiling schemes for an API and make some of the recommendations expressed in the section mandatory.

====== API landing page

The landing page provides links to start exploring the resources offered by the API. It mainly consists in a list of links. New links for TileMatrixSets on top of the common ones are introduced.
...
The TileMatrixSets endpoint retrieves links to the descriptions of the tile matrix sets supported by the API instance in addition to the TileMatrixSets defined in the Annex D and the Annex G of the OGC 17-083r2 standard. The response follows the schema below.
...
The TileMatrixSet endpoint retrieves the full description of a tile matrix set supported by the API instance following the schema described in the OGC 17-083r2 standard. The response follows the TileMatrixSet schema.
