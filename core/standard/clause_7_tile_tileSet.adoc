...
include::requirements/tiles/requirements_class_tileset.adoc[]
...
=== Tileset resource
A tileset resource represents an array of tiles. The resource itself the contains the necessary metadata to enable a client application to formulate a tile request.
