...
This section provides more details on the recommendations for API defined TileMatrixSets. In the future, an extension of this standard could described mechanims to manage (create, update...) tiling schemes for an API and make some ot the recomendations expressed in the section mandatory.
