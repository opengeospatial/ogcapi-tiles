...
This section provides more details on the recommendations for Web API-defined TileMatrixSets. In the future, an extension of this standard could describe mechanism to manage (create, update...) tiling schemes for a Web API and make some of the recommendations expressed in the section mandatory.
