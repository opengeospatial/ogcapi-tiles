...
This conformance class defines a mechanism to retrieve a list of tilesets for a dataset which may contain multiple geospatial data resources. It is used in conjunction with <<rc_tileSets-list>> that specifies the response to this GET request.
