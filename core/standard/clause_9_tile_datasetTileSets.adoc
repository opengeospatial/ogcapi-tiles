...
Combined with the _geodata selection_ conformance class, it is also possible to select specific geospatial data resources (collections) to be combined and retrieved as tiles.
