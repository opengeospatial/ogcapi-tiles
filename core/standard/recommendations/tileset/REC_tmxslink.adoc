...
NOTE: The TileMatrixSet defined in http://docs.opengeospatial.org/is/17-083r4/17-083r4.html#61[Annex D] of OGC 17-083r4 and the variable-width defined in http://docs.opengeospatial.org/is/17-083r4/17-083r4.html#104[Annex E] of OGC 17-083r4 are registered in the OGC TileMatrixSets registry is available at http://opengis.net/def/tms
