...
NOTE: TIFF is an ideal format for storing geospatial grid data with its original data values. However, it can also be used for image palette or RGB imagery.
