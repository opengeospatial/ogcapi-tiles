...
The OGC API - tiles part 1 defines how to retrieve tiles in a TileMatrixSet but does not provide an endpoint to manage the list of TileMatrixSets supported by the API. Actually, the 2DTMS standard defines common TileMatrixSets in the Annex D and Annex G of the OGC 17-083r2 standard that can be used only mentioning the URI without the need to describe them. This requirement class acts as and extension of the core requirements class that adds all the necessary elements to support other TileMatrixSets. It adds a mechanism to fully describe TileMatrixSets that are specific to the API instance.
...
----
{
  links: [
    ...,
    {
      ...
      "rel": "http://www.opengis.net/def/rel/OGC/1.0/tiling-schemas",
